...
func main() {
	...
	netTestsRaw := flag.String("net-tests", cmdutil.EnvOrDefault("CM_NET_TESTS", ""), "网络测试目标列表(逗号分隔): host[:port] | icmp:host | tcp:host[:port] | 名称@目标 | 名称 目标; IPv6 用方括号, 如 \"DNS@tcp:1.1.1.1:443,DNS tcp:1.1.1.1:443\"")
